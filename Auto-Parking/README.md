...
山东大学2020级数据科学与人工智能班计算机视觉项目：强化学习模拟泊车+实际泊车
...
在百度AI Studio基于PP-YOLOv2训练的小车识别模型，详见[[百度AI Studio]基于PP-YOLOv2的小车识别](https://aistudio.baidu.com/projectdetail/8234915)

#### 方向检测

在百度AI Studio基于自己搭建的网络训练的朝向检测模型，详见[[百度AI Studio]小车方向检测](https://aistudio.baidu.com/projectdetail/8234948)
